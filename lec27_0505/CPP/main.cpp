...
void print_account_information(BankCustomer *current_customer) {
  ...
  cout << "Savings Balance: " << current_customer->query_savings_balance()
       << endl
       << endl;
}

// Main function: modify if desired for testing purposes, but do not put any
// required code in this file
int main(int argc, char *argv[]) {
  ...
  bool success = customer1 - 450;
  cout << "Withdraw of 450 from savings" << endl;
  if (success) {
